...
class App extends Container
{
    ...
    public function initialize()
    {
        ...
        $this->routePath   = $this->webpePath . 'route' . DIRECTORY_SEPARATOR;
        $this->configPath  = $this->webpePath . 'config' . DIRECTORY_SEPARATOR;
        ...
        $this->env->set([
            ...
            'webpe_path'   => $this->webpePath,
            'app_path'     => $this->appPath,
            'config_path'  => $this->configPath,
            'route_path'   => $this->routePath,
            'runtime_path' => $this->runtimePath,
            'extend_path'  => $this->webpePath. 'extend' . DIRECTORY_SEPARATOR,
    ...
    public function init($module = '')
    {
        ...
        if (is_file($path . 'init.php')) {
            ...
            // 加载公共文件
            if ($module && is_file($path . 'common.php')) {
                include_once $path . 'common.php';
            }

            if ('' == $module) {
                include_once $this->webpePath . 'functions.php';
                // 加载系统助手函数
    ...
    protected function containerConfigUpdate($module)
    {
        ...
        $this->appDebug && $this->debug->setConfig($config['trace']);
     ...
     * @return string
     */
    public function getWebpePath(){
        return $this->webpePath;
    }
}
